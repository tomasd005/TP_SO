...
echo "=================================================="
echo "====   Iniciando Experiência: FIFO Fairness   ===="
echo "====   Configuração: 1 slots, Política: fifo  ===="
echo "=================================================="
...
read -p "Por favor, inicie o controller noutro terminal com: ./bin/controller 1 fifo e pressione [ENTER] para continuar..."
